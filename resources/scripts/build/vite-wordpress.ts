...
// Source: https://github.com/roots/sage/blob/main/resources/js/build/wordpress.js
    ...
    async generateBundle() {
      ...
      try {
        ...
        while ((match = fontVarRegex.exec(themeContent)) !== null) {
          ...
          if (
            !name.includes('feature-settings') &&
            !name.includes('variation-settings') &&
            !['family', 'size', 'smoothing', 'style', 'weight', 'stretch'].some(
        ...
        const themeJson = {
          __processed__:
            'This file was generated from Tailwind v4 CSS variables',
          ...baseThemeJson,
          settings: {
